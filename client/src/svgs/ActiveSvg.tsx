...
export const ActiveSvg: React.FC<className> = ({ className }) => {
    return <svg className={`${className}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
            <path d="M9 10L12.2581 12.4436C12.6766 12.7574 13.2662 12.6957 13.6107 12.3021L20 5" strokeWidth="2" strokeLinecap="round">
            </path>
