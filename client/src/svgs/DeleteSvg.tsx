...
export const DeleteSvg: React.FC<className> = ({ className }) => {
    return <svg className={`${className}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M6 7V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            </path>
